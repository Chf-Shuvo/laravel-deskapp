                        ...
                        @foreach ($users as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('user-profile.destroy',auth()->user()->id) }}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="user-delete" onclick="return confirm('Are you sure to remove this user?')"><i class="icon-copy dw dw-delete-3"></i></a>
